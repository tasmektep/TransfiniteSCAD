...
namespace SCAD
{
    ...
    public class TriMesh
    {
        ...
        public void resizePoints(int n)
        {
            m_vertices = new List<Point3d>(n);
        }
        ...
        public void addTriangle(int vt_1, int vt_2, int vt_3)
        {
            this.mesh.Faces.AddFace(vt_1, vt_2, vt_3);
        }
    ...
    public class domain
    {
        ...
        Point2d center_;
        public List<Point2d> vertices_ = new List<Point2d>();
        List<Vector2d> du_ = new List<Vector2d>(), dv_ = new List<Vector2d>();

        int next(int i, int j = 1) { return (i + j) % n_; }
        int prev(int i, int j = 1) { return (i + n_ - j) % n_; }
        ...
        List<Point2d> vertices() { return vertices_; }
    ...
    {
        //public static void addTriangle(this Mesh msh, int vt_1, int vt_2, int vt_3)
        //{
        //    msh.Faces.AddFace(vt_1, vt_2, vt_3);
        //}
    }
